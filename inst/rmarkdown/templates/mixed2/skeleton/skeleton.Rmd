...
Data on a range range of Korean pop ("K-pop") and Jazz artists and their tracks was collected through from the Spotify API. You will have a sample of this data to work with. Sampling occured at the artist level. All tracks retrieved for selected artists were included.
